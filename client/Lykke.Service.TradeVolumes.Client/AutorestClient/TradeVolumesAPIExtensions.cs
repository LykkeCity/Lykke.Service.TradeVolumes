...
namespace Lykke.Service.TradeVolumes.Client.AutorestClient
{
    ...
    public static partial class TradeVolumesAPIExtensions
    {
            ...
            /// AssetPair Ids
            /// </param>
            public static IList<AssetPairTradeVolumeResponse> GetPeriodAssetPairsTradeVolume(this ITradeVolumesAPI operations, System.DateTime fromDate, System.DateTime toDate, IList<string> assetPairIds = default(IList<string>))
            {
                return operations.GetPeriodAssetPairsTradeVolumeAsync(fromDate, toDate, assetPairIds).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<AssetPairTradeVolumeResponse>> GetPeriodAssetPairsTradeVolumeAsync(this ITradeVolumesAPI operations, System.DateTime fromDate, System.DateTime toDate, IList<string> assetPairIds = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetPeriodAssetPairsTradeVolumeWithHttpMessagesAsync(fromDate, toDate, assetPairIds, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
