...
namespace Lykke.Service.TradeVolumes.Client.AutorestClient
{
    ...
    public partial class TradeVolumesAPI : ServiceClient<TradeVolumesAPI>, ITradeVolumesAPI
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the TradeVolumesAPI class.
        /// </summary>
        /// <param name='handlers'>
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public TradeVolumesAPI(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public TradeVolumesAPI(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public TradeVolumesAPI(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public TradeVolumesAPI(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<IList<AssetPairTradeVolumeResponse>>> GetPeriodAssetPairsTradeVolumeWithHttpMessagesAsync(System.DateTime fromDate, System.DateTime toDate, IList<string> assetPairIds = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("assetPairIds", assetPairIds);
                tracingParameters.Add("fromDate", fromDate);
                tracingParameters.Add("toDate", toDate);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetPeriodAssetPairsTradeVolume", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/TradeVolumes/pairs/all/{fromDate}/{toDate}").ToString();
            _url = _url.Replace("{fromDate}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(fromDate, SerializationSettings).Trim('"')));
            _url = _url.Replace("{toDate}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(toDate, SerializationSettings).Trim('"')));
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            ...
            {
                _requestContent = SafeJsonConvert.SerializeObject(assetPairIds, SerializationSettings);
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<AssetPairTradeVolumeResponse>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<AssetPairTradeVolumeResponse>>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<HttpOperationResponse<AssetTradeVolumeResponse>> GetPeriodClientAssetTradeVolumeWithHttpMessagesAsync(string assetId, string clientId, System.DateTime fromDate, System.DateTime toDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/TradeVolumes/asset/{assetId}/client/{clientId}/{fromDate}/{toDate}").ToString();
            _url = _url.Replace("{assetId}", System.Uri.EscapeDataString(assetId));
        ...
        public async Task<HttpOperationResponse<AssetPairTradeVolumeResponse>> GetPeriodClientAssetPairTradeVolumeWithHttpMessagesAsync(string assetPairId, string clientId, System.DateTime fromDate, System.DateTime toDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/TradeVolumes/pair/{assetPairId}/client/{clientId}/{fromDate}/{toDate}").ToString();
            _url = _url.Replace("{assetPairId}", System.Uri.EscapeDataString(assetPairId));
            _url = _url.Replace("{clientId}", System.Uri.EscapeDataString(clientId));
            _url = _url.Replace("{fromDate}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(fromDate, SerializationSettings).Trim('"')));
            _url = _url.Replace("{toDate}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(toDate, SerializationSettings).Trim('"')));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<AssetTradeVolumeResponse>> GetPeriodWalletAssetTradeVolumeWithHttpMessagesAsync(string assetId, string walletId, System.DateTime fromDate, System.DateTime toDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (assetId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "assetId");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("toDate", toDate);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetPeriodWalletAssetTradeVolume", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/TradeVolumes/asset/{assetId}/wallet/{walletId}/{fromDate}/{toDate}").ToString();
            _url = _url.Replace("{assetId}", System.Uri.EscapeDataString(assetId));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<AssetPairTradeVolumeResponse>> GetPeriodWalletAssetPairTradeVolumeWithHttpMessagesAsync(string assetPairId, string walletId, System.DateTime fromDate, System.DateTime toDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (assetPairId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "assetPairId");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("toDate", toDate);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetPeriodWalletAssetPairTradeVolume", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/TradeVolumes/pair/{assetPairId}/wallet/{walletId}/{fromDate}/{toDate}").ToString();
            _url = _url.Replace("{assetPairId}", System.Uri.EscapeDataString(assetPairId));
            _url = _url.Replace("{walletId}", System.Uri.EscapeDataString(walletId));
            _url = _url.Replace("{fromDate}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(fromDate, SerializationSettings).Trim('"')));
            _url = _url.Replace("{toDate}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(toDate, SerializationSettings).Trim('"')));
